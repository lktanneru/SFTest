...
import getResults from '@salesforce/apex/Lookup.getResults';
...
export default class LwcMultiLookup extends LightningElement {
   ...
   setSelectedRecord(event) {
        ...
        const selectedEvent = new CustomEvent('lookupselected', { detail: {recId},});
    ...
    removeRecord (event){
        ...
        let selRecords = this.selectedRecords;
        const selectedEvent = new CustomEvent('lookupselected', { detail: {selRecords}, });
        // Dispatches the event.
        this.dispatchEvent(selectedEvent);
    }
